 ...
 data transformation artifact stage
    ...
    def evaluate(self):
        ...
        try:
            ...
            load_model=tensorflow.keras.models.load_model(self.model_trainer_artifacts.trained_model_path)
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifacts:
        ...
        try:
            ...
            trained_model=tensorflow.keras.models.load_model(self.model_trainer_artifacts.trained_model_path)
            with open('tokenizer.pickle', 'rb') as handle:
